...
export const MOCK_PACKAGES: MockPackage[] = [
  ...
  {
    id: 'pkg-003',
    digitalId: 'CW-2026-PKG-003',
    name: 'Auto Parts Bundle',
    length: 120,
    width: 80,
    height: 50,
    weight: 210,
  ...
  {
    id: 'pkg-005',
    digitalId: 'CW-2026-PKG-005',
    name: 'Textile Rolls Pallet',
    length: 200,
    width: 100,
    height: 80,
    weight: 320,
  ...
  {
    id: 'pkg-006',
    digitalId: 'CW-2026-PKG-006',
    name: 'Pharmaceutical Cold Pack',
    length: 40,
    width: 35,
    height: 30,
    weight: 15,
  ...
  {
    id: 'pkg-007',
    digitalId: 'CW-2026-PKG-007',
    name: 'Construction Steel Rods',
    length: 300,
    width: 30,
    height: 30,
    weight: 480,
  ...
  {
    id: 'pkg-008',
    digitalId: 'CW-2026-PKG-008',
    name: 'Precision Instruments Set',
    length: 70,
    width: 55,
    height: 50,
    weight: 68,
  ...
  {
    id: 'pkg-009',
    digitalId: 'CW-2026-PKG-009',
    name: 'FMCG Goods Carton Stack',
    length: 150,
    width: 100,
    height: 120,
    weight: 280,
  ...
  {
    id: 'pkg-010',
    digitalId: 'CW-2026-PKG-010',
    name: 'Chemical Drums (Sealed)',
    length: 90,
    width: 90,
    height: 110,
    weight: 390,
  ...
  {
    id: 'pkg-011',
    digitalId: 'CW-2026-PKG-011',
    name: 'Furniture Flat Pack x6',
    length: 180,
    width: 80,
    height: 15,
    weight: 95,
  ...
  {
    id: 'pkg-013',
    digitalId: 'CW-2026-PKG-013',
    name: 'Agri Equipment Parts',
    length: 140,
    width: 90,
    height: 60,
    weight: 260,
  ...
  {
    id: 'pkg-014',
    digitalId: 'CW-2026-PKG-014',
    name: 'Ceramic Tiles Pallet',
    length: 120,
    width: 80,
    height: 60,
    weight: 540,
  ...
  {
    id: 'pkg-015',
    digitalId: 'CW-2026-PKG-015',
    name: 'Frozen Food Container',
    length: 80,
    width: 70,
    height: 65,
    weight: 190,
  ...
  {
    id: 'pkg-016',
    digitalId: 'CW-2026-PKG-016',
    name: 'Optical Fiber Spools',
    length: 110,
    width: 110,
    height: 90,
    weight: 155,
  ...
  {
    id: 'pkg-017',
    digitalId: 'CW-2026-PKG-017',
    name: 'Bagged Cement x20',
    length: 200,
    width: 100,
    height: 100,
    weight: 1000,
  ...
  {
    id: 'pkg-019',
    digitalId: 'CW-2026-PKG-019',
    name: 'Hydraulic Press Components',
    length: 95,
    width: 75,
    height: 85,
    weight: 310,
  ...
  {
    id: 'pkg-020',
    digitalId: 'CW-2026-PKG-020',
    name: 'Glassware Export Carton',
    length: 65,
    width: 55,
    height: 60,
    weight: 48,
  ...
  {
    id: 'pkg-023',
    digitalId: 'CW-2026-PKG-023',
    name: 'Network Switch Stack',
    length: 50,
    width: 45,
    height: 40,
    weight: 18,
  ...
  {
    id: 'pkg-024',
    digitalId: 'CW-2026-PKG-024',
    name: 'Bulk Grain Bags x30',
    length: 250,
    width: 120,
    height: 100,
    weight: 1500,
...
export const MOCK_SHIPMENTS: MockShipment[] = [
  {
    id: 'shipment-001',
    truckId: 'truck-001',
    truckRegistration: 'MH-12-AB-4521',
    loaderId: 'user-002',
    loaderName: 'Arjun Singh',
    status: 'LOADING',
    origin: 'Mumbai Warehouse A',
    destination: 'Pune Distribution Hub',
    departureTime: '2026-08-13T14:00:00Z',
    arrivalTime: '2026-08-13T17:00:00Z',
    totalWeight: 8450,
    totalVolume: 12.4,
    packageCount: 7,
  ...
  },
  {
    id: 'shipment-002',
    truckId: 'truck-002',
    truckRegistration: 'DL-01-CG-7834',
    loaderId: 'user-003',
    loaderName: 'Priya Sharma',
    status: 'IN_TRANSIT',
    origin: 'Delhi NCR Depot',
    destination: 'Ahmedabad Logistics Park',
    departureTime: '2026-08-12T06:00:00Z',
    arrivalTime: '2026-08-13T18:00:00Z',
    totalWeight: 15800,
    totalVolume: 28.7,
    packageCount: 3,
  ...
  },
  {
    id: 'shipment-003',
    truckId: 'truck-005',
    truckRegistration: 'TN-22-HJ-8801',
    loaderId: 'user-003',
    loaderName: 'Priya Sharma',
    status: 'IN_TRANSIT',
    origin: 'Chennai Port Yard',
    destination: 'Hyderabad Central',
    departureTime: '2026-08-11T08:00:00Z',
    arrivalTime: '2026-08-13T20:00:00Z',
    totalWeight: 25300,
    totalVolume: 42.1,
    packageCount: 3,
  ...
  },
  {
    id: 'shipment-004',
    truckId: 'truck-007',
    truckRegistration: 'UP-80-MN-6673',
    loaderId: 'user-002',
    loaderName: 'Arjun Singh',
    status: 'DELAYED',
    ...
    arrivalTime: '2026-08-12T10:00:00Z',
    totalWeight: 12500,
    totalVolume: 18.9,
    packageCount: 4,
  ...
  },
  {
    id: 'shipment-005',
    truckId: 'truck-003',
    truckRegistration: 'GJ-05-DE-2290',
    loaderId: 'user-002',
    loaderName: 'Arjun Singh',
    status: 'DELIVERED',
    origin: 'Jaipur Depot',
    destination: 'Lucknow Warehouse',
    departureTime: '2026-08-07T06:00:00Z',
    arrivalTime: '2026-08-08T18:00:00Z',
    totalWeight: 11200,
    totalVolume: 22.8,
    packageCount: 4,
...
export const MOCK_TRACKING_EVENTS: MockTrackingEvent[] = [
  ...
  },
  {
    ...
    location: 'Mumbai Warehouse A — Bay 3',
...
export const MOCK_NOTIFICATIONS: MockNotification[] = [
  {
    ...
    message:
      'Truck UP-80-MN-6673 is delayed due to road closure on NH-275. New ETA: Aug 14, 10:00.',
    isRead: false,
    relatedEntityId: 'shipment-004',
  ...
  },
  {
    ...
    isRead: true,
    relatedEntityId: 'shipment-005',
    createdAt: '2026-08-08T18:35:00Z',
  },
  {
    id: 'notif-006',
    userId: 'user-002',
...
export const LOADER_PACKAGE_QUEUE: MockLoadingPackage[] = [
  {
    ...
    loadingOrder: 1,
    isLoaded: true,
    stackingNote: 'Bottom layer, secure with straps',
  },
  {
    ...MOCK_PACKAGES[1],
    loadingOrder: 2,
    isLoaded: true,
    stackingNote: 'TOP SHELF ONLY — FRAGILE',
  },
  { ...MOCK_PACKAGES[2], loadingOrder: 3, isLoaded: false, stackingNote: 'Heavy base layer' },
  {
    ...
    loadingOrder: 4,
    isLoaded: false,
    stackingNote: 'Do not stack above 2 layers',
  },
  ...
  { ...MOCK_PACKAGES[23], loadingOrder: 6, isLoaded: false, stackingNote: 'Floor position only' },
  {
    ...
    loadingOrder: 7,
    isLoaded: false,
    stackingNote: 'Secure refrigeration unit upright',
  },
];
